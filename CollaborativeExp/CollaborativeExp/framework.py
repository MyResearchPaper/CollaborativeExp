...
class CollaborativeExp:  
    ...
    def init_model(self):        
        self.loadG()  
        #GCN weight matrixs
        self.GCNW_1 =CollaborativeExp.weight_variable((self.G.number_of_nodes(), 32)) 
        print("GCNW1=",self.GCNW_1.shape)
        self.GCNW_2 =CollaborativeExp.weight_variable((self.GCNW_1.shape[1], self.d))
        print("GCNW2=",self.GCNW_2.shape)
        
        #regression layer
        self.regindim=4*self.GCNW_2.shape[1]+11
        self.W1=CollaborativeExp.weight_variable((self.regindim,8))
        #self.W2=EndCold.weight_variable((self.W1.shape[1],8))
        #self.W3=EndCold.weight_variable((self.W2.shape[1],16))
        self.W4 = CollaborativeExp.weight_variable2(self.W1.shape[1])
        ...
        self.mus = CollaborativeExp.kernal_mus(self.n_bins, use_exact=True)
        self.sigmas = CollaborativeExp.kernel_sigmas(self.n_bins, self.lamb, use_exact=True)
